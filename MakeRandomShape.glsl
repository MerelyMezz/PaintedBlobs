...
layout(location = 5) uniform float InitialShapeMaxSize;
layout(location = 6) uniform vec4 FocusArea;
...
void main()
{
	ShapeData.Pos = vec2(RandomFloat(0, FocusArea.r, FocusArea.g), RandomFloat(1, FocusArea.b, FocusArea.a));
	ShapeData.Size = vec2(RandomFloat(2, 0.001, InitialShapeMaxSize), RandomFloat(3, 0.001, InitialShapeMaxSize));
